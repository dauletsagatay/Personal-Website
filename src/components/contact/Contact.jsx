            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <a href="mailto:sagatay.daulet@gmail.com" className="contact__button">Write me{" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>              
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">+77078113797</span>
                    ...
                    {/* <div className="contact__card">
                        ...
                        <span className="contact__card-data">dake.fb</span>
